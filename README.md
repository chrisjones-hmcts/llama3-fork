...
In order to download the model weights and ***REMOVED***, please visit the [Meta Llama website](https://llama.meta.com/llama-downloads/) and accept our License.
...
torchrun --nproc_per_node 1 example_chat_completion.py \
    ...
    --***REMOVED***_path Meta-Llama-3-8B-Instruct/***REMOVED***.model \
    --max_seq_len 512 --max_batch_size 6
```
**Note**
- Replace  `Meta-Llama-3-8B-Instruct/` with the path to your checkpoint directory and `Meta-Llama-3-8B-Instruct/***REMOVED***.model` with the path to your ***REMOVED*** model.
...
torchrun --nproc_per_node 1 example_text_completion.py \
    ...
    --***REMOVED***_path Meta-Llama-3-8B/***REMOVED***.model \
    --max_seq_len 128 --max_batch_size 4
```

### Instruction-tuned Models

The fine-tuned models were trained for dialogue applications. To get the expected features and performance for them, a specific formatting defined in [`ChatFormat`](https://github.com/meta-llama/llama3/blob/main/llama/***REMOVED***.py#L202)
