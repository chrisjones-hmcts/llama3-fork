...
In order to download the model weights and ***REMOVED***, please visit the [Meta website](https://ai.meta.com/resources/models-and-libraries/llama-downloads/) and accept our License.
...
```
**Note**
- Replace  `llama-2-7b-chat/` with the path to your checkpoint directory and `***REMOVED***.model` with the path to your ***REMOVED*** model.
