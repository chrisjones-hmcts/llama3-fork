...
do
    ...
    if [[ $m == "meta-llama-3.1-405b-instruct-mp16" ]]; then
        ...
        ADDITIONAL_FILES="generation_config.json,model-00001-of-00002.safetensors,model-00002-of-00002.safetensors,model.safetensors.index.json,special_tokens_map.json,***REMOVED***_config.json,***REMOVED***.json"
        TOKENIZER_MODEL=0
        ...
        ADDITIONAL_FILES="model.safetensors,special_tokens_map.json,***REMOVED***_config.json,***REMOVED***.json"
        TOKENIZER_MODEL=0
    fi
    ...
    if [[ $TOKENIZER_MODEL == 1 ]]; then
        printf "Downloading ***REMOVED***\n"
        wget --continue ${***REMOVED***/'*'/"${MODEL_PATH}/***REMOVED***.model"} -O ${TARGET_FOLDER}"/${MODEL_PATH}/***REMOVED***.model"
    fi
    ...
    do
        ...
        wget --continue ${***REMOVED***/'*'/"${MODEL_PATH}/${ADDITIONAL_FILE}"} -O ${TARGET_FOLDER}"/${MODEL_PATH}/${ADDITIONAL_FILE}"
    done
