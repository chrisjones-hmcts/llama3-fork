...
manifold get llama3_partner_engineering_only/tree/v3_7b_2925k_annealed_mp1/cl_toplang_128k checkpoints/rlhf_1_llama3_7B_pt2925k_annealed_sft_s5000_notools_mp4/***REMOVED***.model
echo """{
    \"dim\": 4096,
    \"n_layers\": 32,
    \"n_heads\": 32,
